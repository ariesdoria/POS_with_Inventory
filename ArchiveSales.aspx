<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ArchiveSales.aspx.cs" Inherits="Admin_ArchiveSales" %>
    ...
    <div>
        ...
        <div class="salesTab">
            <table>
                <tr>
                    <td>
                        <h4 style="width:500px">Archive Sales</h4>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="salesSearch">
            ...
            <tr>
                <td>
                    <asp:TextBox ID="txtSearchSales" runat="server" PlaceHolder="Search Sales" Width="198px" CssClass="form-control" style="margin-left:10px" />
                </td>
                <td></td>
                <td><asp:Button ID="btnSearchSales" runat="server" Text="Search Sales" CssClass="btn btn-primary" Width="125px" style="margin-left:10px" OnClick="btnSearchSales_Click" /></td>
                <td></td>
                ...
                <td></td>
                <td><asp:Button ID="btnDelete" runat="server" OnClientClick="confirmDelete();" CssClass="btn btn-danger" style="margin-left:10px" Text="Delete" Width="81px" OnClick="btnDelete_Click" /><asp:HiddenField ID="hfCount" runat="server" Value="0" /></td>
                <td></td>
            </tr>
        </table>
        <table>
        ...
        <div class="salesCount">
            <table>
                <tr>
                    <td>
                        Archived Sales:<asp:Label ID="lblArchiveSalesCount" runat="server" Text="Label" Visible="false" />
                    </td>
                </tr>
            </table>
        </div> 
        <div class="salesTable">
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="815px">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Point_Of_SalesConnectionString %>" SelectCommand="SELECT * FROM [Archived_Sales]"></asp:SqlDataSource>
                    </td>
                </tr>
            </table>
        </div>
